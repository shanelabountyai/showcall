...
| S-2 | Cue graph: run-sheet cues per room/day derived from agenda + production items, dependency anchors, cascade preview → atomic commit, slack and impossible-compression detection | ⏳ next |
